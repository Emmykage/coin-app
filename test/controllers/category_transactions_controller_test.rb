...
class CategoryTransactionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test 'should create category_transaction' do
    assert_difference('CategoryTransaction.count') do
      post category_transactions_url,
           params: { category_transaction: { category_id: @category_transaction.category_id,
                                             transaction_id: @category_transaction.transaction_id } }
    end
  ...
  test 'should update category_transaction' do
    patch category_transaction_url(@category_transaction),
          params: { category_transaction: { category_id: @category_transaction.category_id,
                                            transaction_id: @category_transaction.transaction_id } }
